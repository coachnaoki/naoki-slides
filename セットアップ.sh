...
echo ""
echo "  👉 https://docs.google.com/presentation/d/__NAOKI_SLIDE_TEMPLATE_ID__/copy"
echo ""
...
echo "  以下のリンクをブラウザで開き、「コピーを作成」を押してください："
echo ""
echo "  👉 https://script.google.com/home/projects/__NAOKI_GAS_TEMPLATE_ID__/copy"
echo ""
echo "  コピー後、以下の手順でデプロイ:"
echo ""
echo "    1. 画面右上の「デプロイ」ボタン → 「新しいデプロイ」"
echo "    2. 種類: 「ウェブアプリ」を選択"
echo "    3. 次のユーザーとして実行: 「自分」"
echo "    4. アクセスできるユーザー: 「自分のみ」"
echo "    5. 「デプロイ」ボタンを押す"
echo "    6. 初回は承認ダイアログが出る:"
echo "       「詳細」→「{プロジェクト名}（安全ではないページ）に移動」→ 許可"
echo "    7. 表示された「ウェブアプリ URL」をコピー"
echo ""
...
echo "  次のステップ:"
echo ""
echo "  1. ライセンス認証（未認証の場合）:"
echo "     node scripts/validateLicense.mjs NK-XXXX-XXXX-XXXX"
echo ""
echo "  2. 新規プレゼンを作成:"
echo "     ./新規スライド.sh"
echo ""
echo "  3. Claude Code でスキル起動:"
echo "     cd presentations/<プレゼン名>"
